    ...
    const htmlContent = `
      ...
      <body style="font-family: 'Barlow', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #3E2723; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="text-align: center; margin-bottom: 30px;">
          <h1 style="font-family: 'Tenor Sans', sans-serif; color: #3E2723; margin-bottom: 10px;">✅ Profile Completed!</h1>
        </div>
        ...
        <div style="background-color: #F5F2ED; border-radius: 8px; padding: 15px; margin: 20px 0;">
          <p style="margin: 0 0 10px 0; font-weight: 600; color: #3E2723;">Profile Updates:</p>
